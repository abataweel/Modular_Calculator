...
def standard_menu():
    ...
    while True:
        ...
        # operations from 1-6 require 2 numbers for input
        if choice in [1, 2, 3, 4, 5, 6]:
            while True:
                ...
                if num1 is None or num2 is None:
                    ...
                    if num2 == 0:
                        print("\033[91mError: Cannot divide modulo by zero.\033[0m")
                        time.sleep(2)
                        continue  
                    result = num1 % num2
                    print("The answer is ", result)
                    logCalc("standard", "remainder", f"({num1},{num2})", result)
                    print("Result logged to history ✅")
                    time.sleep(2)
                    break
            ...
            while True:
                ...
                result = 1 / num
                print("The answer is ", result)
                logCalc("standard", "Reciprocal", num, result)
                print("Result logged to history ✅")
                time.sleep(2)
                break
